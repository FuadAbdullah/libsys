...
switch($_getOptionB)
{
  ...
  case "genre":
    $_sqlB = "SELECT
            ...
            FROM book_t
            GROUP BY bk_genre";
    $_titleB = "Chart of Book Genres Against Number of Books for Each Genre";
    //$_subtitle = "Sorted in Ascending Alphabetical Order of the Genres";
    $_filterdispB = "Genre";
    $_xaxisB = "Genre";
    $_yaxisB = "Number of Books";
    break;
  //For 'Priority' option
   case "priority":
    $_sqlB = "SELECT
    ...
    $_titleB = "Chart of Book Priority Against Number of Books for Each Priority";
    //$_subtitle = "Sorted in Ascending Numerical Order of the Days Limit";
    $_filterdispB = "Priority";
    $_xaxisB = "Priority";
    $_yaxisB = "Number of Books";
    break;
    ///////////////////////////////////////////////////////////////////////////////////////////////
  ...
  case "c_gender":
    $_sqlB = "SELECT   
            ...
            FROM client_t
            GROUP BY cl_gender"; 
    $_titleB = "Chart of Client Gender Against Number of Clients for Each Gender";
    //$_subtitle = "Sorted in Ascending Numerical Order of the Days Limit";
    $_filterdispB = "Gender";
    $_xaxisB = "Gender";
    $_yaxisB = "Number of Clients";
    break;
  case "c_dob":
    $_sqlB = "SELECT
            CASE
            ...
            GROUP BY client_dob
            ORDER BY cl_dob"; 
    $_titleB = "Chart of Client Birth Date Against Number of Clients for Each Year Range";
    //$_subtitle = "Sorted in Ascending Numerical Order of the Days Limit";
    $_filterdispB = "Birth Date";
    $_xaxisB = "Birth Date";
    $_yaxisB = "Number of Clients";
    break;
    case "c_state":
    ...
    $_titleB = "Chart of Client State Area Against Number of Clients for Each State";
    //$_subtitle = "Sorted in Ascending Numerical Order of the Days Limit";
    $_filterdispB = "State";
    $_xaxisB = "State";
    $_yaxisB = "Number of Clients";
  ...
  case "l_gender":
    $_sqlB = "SELECT   
            ...
            FROM librarian_t
            GROUP BY lb_gender"; 
    $_titleB = "Chart of Librarian Gender Against Number of Librarians for Each Gender";
    //$_subtitle = "Sorted in Ascending Numerical Order of the Days Limit";
    $_filterdispB = "Gender";
    $_xaxisB = "Gender";
    $_yaxisB = "Number of Librarians";
    break;
  case "l_dob":
    $_sqlB = "SELECT
            CASE
            ...
            ORDER BY lb_dob"; 
    $_titleB = "Chart of Librarian Birth Date Against Number of Librarians for Each Year Range";
    //$_subtitle = "Sorted in Ascending Numerical Order of the Days Limit";
    $_filterdispB = "Birth Date";
    $_xaxisB = "Birth Date";
    $_yaxisB = "Number of Librarians";
    ...
    $_titleB = "Chart of Librarian State Area Against Number of Librarians for Each State";
    //$_subtitle = "Sorted in Ascending Numerical Order of the Days Limit";
    $_filterdispB = "State";
    $_xaxisB = "State";
    $_yaxisB = "Number of Librarians";
  ...
  case "a_gender":
    $_sqlB = "SELECT   
            ...
            FROM admin_t
            GROUP BY adm_gender"; 
    $_titleB = "Chart of Admin Gender Against Number of Admins for Each Gender";
    //$_subtitle = "Sorted in Ascending Numerical Order of the Days Limit";
    $_filterdispB = "Gender";
    $_xaxisB = "Gender";
    $_yaxisB = "Number of Admins";
    break;
  case "a_dob":
    $_sqlB = "SELECT
            CASE
            ...
            GROUP BY admin_dob
            ORDER BY adm_dob"; 
    $_titleB = "Chart of Admin Birth Date Against Number of Admins for Each Year Range";
    //$_subtitle = "Sorted in Ascending Numerical Order of the Days Limit";
    $_filterdispB = "Birth Date";
    $_xaxisB = "Birth Date";
    $_yaxisB = "Number of Admins";
    ...
    $_titleB = "Chart of Admin State Area Against Number of Admins for Each State";
    //$_subtitle = "Sorted in Ascending Numerical Order of the Days Limit";
    $_filterdispB = "State";
    $_xaxisB = "State";
    $_yaxisB = "Number of Admins";
...
$_queryB = mysqli_query($conn1, $_sqlB);

$_numrowsB = mysqli_num_rows($_queryB);

if ($_numrowsB <= 0)
{
  echo "<script>alert('Failed to retrieve any records for chart B from the database!');</script>";
